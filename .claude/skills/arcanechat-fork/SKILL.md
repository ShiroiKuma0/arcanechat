...
| App version scheme | `versionName <upstream>+<N>`, base `versionCode <upstreamCode> + N` (final per-ABI is `×10+abi`); currently `2.49.0+2` / base `30000744`; committed bump per feature (see Versioning) |
