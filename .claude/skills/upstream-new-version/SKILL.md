...
All from the first real sync (`v2.49.0 → v2.53.0`, 2026-07-02):
...
- **Monotonic version guard** — see the Non-negotiables entry; `2.53.0` had to start at `+4`/`30000750` because upstream's base (`30000746`) trailed our shipped `30000749`.
